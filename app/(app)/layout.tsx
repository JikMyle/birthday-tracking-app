...
export default function UserLayout({ 
    ...
    return (
        <div className="relative flex flex-col h-screen w-screen bg-base-100 font-sans overflow-hidden">
            <TopBar></TopBar>

            <main className="w-full h-full px-2 py-8 md:p-12 overflow-scroll">
                { children }   
            </main>     
        </div>
    )
...
function TopBar(): React.ReactNode {
    return (
        <header className="flex items-center w-full h-16 p-4 gap-4 shadow-md text-primary-content bg-primary">
