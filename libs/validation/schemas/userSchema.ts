...
export const birthdateSchema = z
    ...
    .min(new Date("1900-01-01"), { message: "Birthdate must be on or after 1900-01-01" });
...
export const roleSchema = z
    .enum(Role, { error: "Role must be a valid value" });

export const emailPreferenceSchema = z
    .enum(EmailPreference, { error: "Email preference must be a valid value" });
